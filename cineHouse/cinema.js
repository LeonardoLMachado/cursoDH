...
funcoes.adicionarFilme(
  new Filme(1, "Harry Potter", 90, ["Daniel Radcliffe", "Emma Stone"], 2001, false),
  catalogo
);
funcoes.adicionarFilme(
  new Filme(2, "Codigo de Conduta", 180, ["Gerard Butler"], 2011, false),
  catalogo
);
funcoes.adicionarFilme(
  new Filme(3, "Animais Fantasticos", 120, ["Depp"], 2022, true),
  catalogo
);
...
console.log(
  "O filme encontrado foi: " + funcoes.buscarFilme(1, catalogo).titulo
);
